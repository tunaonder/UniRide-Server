...
var api = new ParseServer({
  ...
  push: {
    ios: {
      pfx: 'certs/personalCert.p12', // The filename of private key and certificate in PFX or PKCS12 format from disk  
      cert: 'certs/BilkentRide.cer', // If not using the .p12 format, the path to the certificate PEM to load from disk
